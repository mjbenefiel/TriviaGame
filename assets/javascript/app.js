	...
	function startGame() {
        ...
        function displayQuestion() {
         ...
         function selectedOption() {
            ...
            // contestant = $(this).data("id");
             historyQuestions[0].answer;
             if(contestant != historyQuestions[0].answer) {
            
             $('#result').html("Wrong Answer! The correct answer is AAAAA");
             wrongAnswer++;
            
            } else if (contestant === historyQuestions[0].answer) {
